...
class B2 {
	...
	/**
	 * Check if this instance has been authorized within the last 24 hours.
	 * 
	 * @returns {boolean}
	 */
	isAuthorized() {
		return this.authorization && this.lastAuthorization &&
			this.lastAuthorization.getTime() - Date.now() < 24 * 3600 * 1000;
	}
